...
function default_1() {
    ...
    window.get_estimate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var return_flag, token, result, check_logined, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, fetch("http://localhost:3000/api/pre_estimate", {
                                method: "post",
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/, return_flag];
                }
            });
        });
    };
