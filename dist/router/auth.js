...
var oauthModel_1 = __importDefault(require("../db/model/oauthModel"));
...
router.get("/google/callback", passport_1.default.authenticate("google", {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, oauthModel_1.default.find(req.user._json.email)];
                case 1:
                    result = _a.sent();
                    if (result === null) {
                        ...
                        if (save_token_1 === undefined) {
                            oauthModel_1.default.tokenUpdate(req, res, req.user._json.email, _refresh_token_1, result._id);
                        }
                        else {
                ...
                case 1:
                    ...
                    if (result === null) {
                        ...
                        if (save_token_2 === undefined) {
                            oauthModel_1.default.tokenUpdate(req, res, req.user._json.email, _refresh_token_2, result._id);
                        }
                        else {
                            validation_refreshToken = new Promise(function (resolve, reject) {
                                try {
