...
jusoController.find = function () { return __awaiter(void 0, void 0, void 0, function () {
    var a;
...
jusoController.save = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var i, a;
    return __generator(this, function (_a) {
        for (i = 0; i < data.length; i++) {
            a = new jusoModel_1.default({ sigunguCode: data[i] });
            a.save();
        }
        return [2 /*return*/];
    });
...
//# sourceMappingURL=jusoController.js.map