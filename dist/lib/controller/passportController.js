...
var passportModel_1 = __importDefault(require("../model/passportModel"));
var passportController = {};
passportController.find = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, passportModel_1.default.findOne({ email: email })];
            case 1:
                result = _a.sent();
...
passportController.save = function (req, res, data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, passportModel_1.default.find({ email: data.oauth_email })];
            case 1:
                result = _a.sent();
                userData = {
                ...
                return [4 /*yield*/, new passportModel_1.default(userData).save()];
            case 2:
                newOauth = _a.sent();
