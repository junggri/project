...
var providerGotModel_1 = __importDefault(require("./providerGotModel"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, providerGotModel_1.default.save(registerSympton._id, sentProvidersArray)];
            case 5:
                _a.sent();
                _a.label = 6;
...
registerSymController.deleteSympton = function (req, res, email, id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, providerGotModel_1.default.delete(req.body.id)];
            case 2:
                _a.sent();
...
//# sourceMappingURL=registerSymptonModel.js.map