...
var provider = {
    ...
    find: function (email) { return __awaiter(void 0, void 0, void 0, function () {
        var conn, _a, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, conn.execute("select * from user where email=?", [email])];
                case 3:
    ...
    setOrUpdateRefreshToken: function (token, email) { return __awaiter(void 0, void 0, void 0, function () {
        var conn;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mysql_test_1.default()];
